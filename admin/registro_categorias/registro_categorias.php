...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <section id="conp">
            <form id="registro_categorias">
                <label>Nombre de la categoría</label>
                <input id="cat_nombre" name="cat_nombre" type="text">
                <input id="cat_prod" class="bota" type="button" value="Publicar">
            </form>
            <section id="alerta">
...
<script>
    $(window).ready(function(){
        $('#cat_prod').click(function(){
            $.post("../procesos/registro_categoria.php", $('#registro_categorias').serialize(), function(response){
                if(response){
                    alert(response)
                }else{
                    alert(response)
